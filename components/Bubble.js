...
const __starredMessages = (state) => state.messages.starredMessages
const _chatId = (state, chatId) => chatId
const _starredMessages = createSelector(
  [__starredMessages, _chatId],
...
const Bubble = (props) => {
  ...
  const starredMessages = useSelector((state) => _starredMessages(state, chatId))
